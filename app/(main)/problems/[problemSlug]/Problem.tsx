...
const RichEditor = dynamic(() => import("@/components/problem/RichEditor"), {
  ssr: false,
  loading: () => (
    <div className="h-full w-full animate-pulse rounded-md bg-muted/20" />
  ),
});
const AIMentor = dynamic(() => import("@/components/problem/AIMentorChat"), {
  ssr: false,
  loading: () => (
    <div className="h-full w-full animate-pulse rounded-md bg-muted/20" />
  ),
});
const TestCaseRunner = dynamic(
  () => import("@/components/problem/TestCaseRunner"),
  {
    ssr: false,
    loading: () => (
